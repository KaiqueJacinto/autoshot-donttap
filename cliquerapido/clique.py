...
def clica(x,y):
    ...
    win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN,0,0) # Aperta o botão esquerdo do mouse para baixo
    win32api.mouse_event(win32con.MOUSEEVENTF_LEFTUP,0,0) # Solta o botão esquerdo
